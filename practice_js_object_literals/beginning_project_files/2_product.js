...
// Make up the values for the properties, just make sure the inventory is a whole number (it's the number 
//of that product currently in stock) and unit_price is a floating point number like 45.99
// -- name
// -- inventory
// -- unit_price
...
console.log(product);
// 2. Create a function named addInventory(). The function should accept 2 parameters -- the product 
//object, and the number to add to the inventory. The function adjusts the product object's inventory 
//property by adding the number passed into the function. 
...
// 4. Create a function named processSale(). The function should accept 2 parameters -- the product 
//object, and the number to of products that were sold. The function adjusts the product object's 
//inventory property by subtracting the number passed into the function. The function also returns 
//the total sale which is the unit_price multiplied by the number passed into the function
...
function processSale(item, quantity) {
    item.inventory -= quantity;
    let totalSale = item.unit_price * quantity;
    console.log(product);
